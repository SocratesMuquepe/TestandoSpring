package com.osti.spring.Controller;

import com.osti.spring.Logica.PersonLogic;
...
public class DefaultController {
    ...
    @RequestMapping(value = "/person_list.html", method = RequestMethod.GET)
    public String getlist(ModelMap map) {

        map.addAttribute("list", PersonLogic.list());

        return "list";
    }

    @RequestMapping(value = "/redirect.html", method = RequestMethod.GET)
    public String redirect(@RequestParam(value = "p", required = true) String p) {
